...
export default function AdminEcommerceOrderNewPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      router.push(`/admin/ecommerce/orders/${data.order.orderId}`);
    } catch {
  ...
  return (
    <DashboardLayout>
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Create Ecommerce Order</CardTitle>
          </CardHeader>
