    ...
    onMessage: (evt) => {
      try {
        ...
        if (evt.type === 'incoming_call') {
          ...
          if (callId && data.callId && data.callId !== callId) return; // ignore stale/other calls
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-6 text-center">
            ...
            <div className="flex justify-center gap-4">
              <Button onClick={rejectIncomingCall} className="bg-red-500 hover:bg-red-600">
                <X className="w-4 h-4 mr-2" /> Reject
              </Button>
              <Button onClick={acceptIncomingCall} className="bg-green-500 hover:bg-green-600">
